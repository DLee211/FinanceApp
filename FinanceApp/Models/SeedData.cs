                       ...
                       DbContextOptions<FinanceAppContext>>()))
        {
            ...
            context.Transaction.AddRange(
                new Transaction
                {
                    ...
                    Value = 150.0m,
                    Date = DateTime.Now.AddDays(-7).Date, // 1 week ago
                ...
                new Transaction
                {
                    Name = "Monthly rent",
                    Value = 1200.0m,
                    Date = DateTime.Now.AddDays(-14).Date, // 2 weeks ago
                ...
                new Transaction
                {
                    ...
                    Value = 80.0m,
                    Date = DateTime.Now.AddDays(-21).Date, // 3 weeks ago
                ...
                new Transaction
                {
                    Name = "Movie tickets",
                    Value = 30.0m,
                    Date = DateTime.Now.AddDays(-28).Date, // 4 weeks ago
                ...
                new Transaction
                {
                    Name = "Bus fare",
                    Value = 20.0m,
                    Date = DateTime.Now.AddDays(-35).Date, // 5 weeks ago
                ...
                new Transaction
                {
                    ...
                    Value = 200.0m,
                    Date = DateTime.Now.AddDays(-42).Date, // 6 weeks ago
                ...
                new Transaction
                {
                    Name = "Gym membership",
                    Value = 50.0m,
                    Date = DateTime.Now.AddDays(-49).Date, // 7 weeks ago
                    CategoryId = categories[3].Id // use the Id of the Entertainment category
                },
                new Transaction
                {
                    Name = "Gas bill",
                    Value = 60.0m,
                    Date = DateTime.Now.AddDays(-56).Date, // 8 weeks ago
                    CategoryId = categories[2].Id // use the Id of the Utilities category
                }
            );
